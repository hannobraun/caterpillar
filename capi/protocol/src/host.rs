//! # Host-specific data types
//!
//! ## Implementation Note
//!
//! This doesn't really belong in `capi-protocol`, which could additionally very
//! well be host-agnostic. But right now there's no need to make it so, and
//! while that is true, this is as good a place for this code as any, as
//! anything that needs to depend on this code already depends on
//! `capi-protocol` anyway.
